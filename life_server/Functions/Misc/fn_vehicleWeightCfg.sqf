...
case "I_Heli_light_03_unarmed_F": {20};
case "O_Heli_Light_02_unarmed_F": {20};
case "I_Heli_Transport_02_F": {20};
case "O_Heli_Attack_02_black_F": {20};
case "B_Heli_Attack_01_F": {20};
case "B_Heli_Transport_01_F": {20};
case "O_Heli_Transport_04_covered_F": {20};
case "O_Heli_Transport_04_bench_F": {20};
case "B_Heli_Transport_01_camo_F": {20};
