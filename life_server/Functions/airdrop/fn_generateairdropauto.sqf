...
// AIRDROP STARTEN
[[5,"<t size='1.2'><t color='#FF0000'>Approvisionnement</t></t><br/><br/><t size='1'>Un helicoptere va larguer une caisse de munition dans 15 minutes ! La localisation vous sera transmisse prochainement !</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
...
"Airdropmarkertext" setMarkerText "Zone de largage";
"Airdropmarkertext" setMarkerType "mil_warning";
[[5,"<t size='1.2'><t color='#FF0000'>Approvisionnement</t></t><br/><br/><t size='1'>10 minutes avant le parachutage de la caisse ! Regardez votre map pour la localisation !</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
sleep 300;
[[5,"<t size='1.2'><t color='#FF0000'>Approvisionnement</t></t><br/><br/><t size='1'>5 minutes avant le largage du colis !</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
sleep 240;
[[5,"<t size='1.2'><t color='#FF0000'>Approvisionnement</t></t><br/><br/><t size='1'>1 minute avant le largage du colis !</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
...
"airbox_marker" setMarkerColor "ColorBlack";
"airbox_marker" setMarkerText " Colis";
...
[[5,"<t size='1.2'><t color='#FF0000'>Airdrop</t></t><br/><br/><t size='1'>La caisse de munition a ete parachute ! 20 minutes avant sa destruction !</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
...
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addMagazineCargoGlobal ["7Rnd_408_Mag", 10];};
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addWeaponCargoGlobal ["srifle_EBR_F", 1];};
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addMagazineCargoGlobal ["20Rnd_762x51_Mag", 10];};
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addWeaponCargoGlobal ["LMG_Zafir_F", 1];};
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addMagazineCargoGlobal ["150Rnd_762x51_Box", 5];};
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addWeaponCargoGlobal ["arifle_Mk20_F", 5];};
sleep 0.1;
_var=floor(random 2);
...
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addMagazineCargoGlobal ["30Rnd_65x39_caseless_green", 20];};
sleep 0.1;
_var=floor(random 2);
if (_var==1) then {_box addMagazineCargoGlobal ["30Rnd_556x45_Stanag", 20];};
sleep 0.1;
...
deleteVehicle heli3;
sleep 600;
[[5,"<t size='1.2'><t color='#FF0000'>Airdrop</t></t><br/><br/><t size='1'>5 minutes avant la destruction de la caisse</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
sleep 290;
[[5,"<t size='1.2'><t color='#FF0000'>Airdrop</t></t><br/><br/><t size='1'>15 secondes avant la destruction de la caisse</t>"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
sleep 15;
deleteVehicle _box; 
