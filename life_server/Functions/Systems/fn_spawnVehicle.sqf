...
{
  [[1,"Votre vehicule et dispo et assuré tout risque ! "],"life_fnc_broadcast",_unit,false] spawn life_fnc_MP;
}
else
{
  [[1,"Votre vehicule et disponible !"],"life_fnc_broadcast",_unit,false] spawn life_fnc_MP;
};
serv_sv_use = serv_sv_use - [_vid];