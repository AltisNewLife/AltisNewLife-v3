...
_Btn1 buttonSetAction "[life_vInact_curTarget] spawn life_fnc_repairTruck; closeDialog 0;";
	...
	if (license_civ_depanneur) then {
        if (nearestObjects [player, ["B_Truck_01_mover_F","B_G_Offroad_01_repair_F","O_Heli_Transport_04_repair_F"], 5]) then {
		_Btn5 ctrlSetText "Depanneur";
		_Btn5 buttonSetAction "[life_vInact_curTarget] spawn life_fnc_serviceTruck;";
