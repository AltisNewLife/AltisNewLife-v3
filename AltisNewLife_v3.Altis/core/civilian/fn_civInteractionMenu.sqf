...
_Btn4 ctrlSetText "Voler";
_Btn4 buttonSetAction "[] spawn life_fnc_robAction;";
_Btn5 ctrlSetText "Crocheter";
_Btn5 buttonSetAction "[] spawn life_fnc_plockpick; closeDialog 0;";
_Btn6 ctrlSetText "Déchargez Tel";
_Btn6 buttonSetAction "[life_pInact__curTarget] call life_battery = 0";
//if(!(_curTarget getVariable["blindfolded",false]) && (life_inv_blindfold > 0)) then {
//_Btn6 ctrlSetText "Mettre sac";
//_Btn6 buttonSetAction "[] spawn life_fnc_blindfold; closeDialog 0;";
//} else {
//_Btn6 ctrlEnable false;
//};
//if((_curTarget getVariable["blindfolded",false])) then {
//_Btn6 ctrlEnable true;
//_Btn6 ctrlSetText "Enlever sac";
//_Btn6 buttonSetAction "[] spawn life_fnc_blindfoldRemove; closeDialog 0;";
//};
_Btn7 ctrlSetText "Violer";
_Btn7 buttonSetAction "[] spawn life_fnc_rapeAction; closeDialog 0;";
_Btn8 ctrlSetText "Prelever Organe";
_Btn8 buttonSetAction "[] spawn life_fnc_takeOrgans; closeDialog 0;";
_Btn9 ctrlSetText "Vendre esclave";
...
if(player distance (getMarkerPos "slave_trader_center") < 5) then {_Btn9 ctrlEnable true;} else {_Btn9 ctrlEnable false;};