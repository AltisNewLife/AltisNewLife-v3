...
if(!([_uid] call life_fnc_isUIDActive)) exitWith {hint "Le proprietaire n'est pas en connecté vous ne pouvez pas faire de raid !"};
...
_cP = 0.01;
_cpRate = 0.0092;
[[2,format["%1 votre maison a été fracturée par la police !",(_house getVariable "house_owner") select 1]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
while {true} do
{
