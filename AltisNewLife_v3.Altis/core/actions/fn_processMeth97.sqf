...
_oldItem4 = "iode";
_newItem = "meth97";
_hasLicense = missionNamespace getVariable (([_newItem,0] call life_fnc_licenseType) select 0);
...
if(_hasLicense) then
{
    ...
    titleText[format["Tu as fabriqué 5 doses de Méthamphétamine d'une pureté de 97%",_itemName],"PLAIN"];
