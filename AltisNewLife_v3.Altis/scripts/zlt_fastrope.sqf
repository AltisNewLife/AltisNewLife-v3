...
#define STR_SCRIPTS_NAME "FastRope script"
#define STR_SCRIPT_NAME "Script"
#define STR_HELP "Infos"
...
player addAction["<t color='#ffff00'>Lacher les cordes</t>", zlt_fnc_createropes, [], -1, false, false, '','[] call zlt_fnc_ropes_cond'];
player addAction["<t color='#ff0000'>Couper les cordes</t>", zlt_fnc_removeropes, [], -1, false, false, '','not zlt_mutexAction and count ((vehicle player) getvariable ["zlt_ropes", []]) != 0 and player == driver vehicle player && !(player getVariable "restrained")'];
player addAction["<t color='#00ff00'>Descendre en rappel</t>", zlt_fnc_fastrope, [], 15, false, false, '','not zlt_mutexAction and count ((vehicle player) getvariable ["zlt_ropes", []]) != 0 and player != driver vehicle player && !(player getVariable "restrained")'];
