...
SHIFT + L   : Allumer phares ou lumiere des maisons<br/><br/>
------------------------------------------------------------------<br/><br/>
ANIMATION<br/>
...
"
	...
	*PAS DE RACKET* <br/>
	*PAS DE VOL* <br/><br/>
	Si vous commettez un crime, vous serez banni d'île.<br/>
	<br/>
"
		]
	];
...
Pour voler la banque vous devez avoir les éléments suivants : <br/>
  - Une charge explosive (en zone rebelle)<br/>
  ...
  5. Un seul lingot d'or vaut 9500€<br/>
"
		]
	];
