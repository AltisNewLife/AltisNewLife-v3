...
_validMenus = [
	...
	"RscRadio","RscGroupRootMenu","RscMenuReply","RscMenuStatus","","#User:BIS_fnc_addCommMenuItem_menu","RscMenuMove","RscMenuFormations","RscDisplayDebugPublic","Life_Admin_Compensate"
];
...
while {true} do
{
	...
	if(__GETC__(bitch_level) != 0) exitWith {};
